    ...
    class supermag_posts_col extends WP_Widget {
        ...
        public function widget($args, $instance) {
            ...
            if ($supermag_featured_query->have_posts()) :
                ...
                ?>
                <div class="<?php echo esc_attr( $supermag_post_col_layout_class ); ?> featured-entries-col featured-entries <?php echo esc_attr( $supermag_other_class ); ?> featured-col-posts <?php echo esc_attr( $supermag_sidebar_id ); ?>">
                    <?php
